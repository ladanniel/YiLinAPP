 ...
 */
    ...
    $.jstree.core.prototype = {
        ...
        get_selected_parent: function(full) {
        	var obj = [];
        	var obj_note = []; 
        	var parent = [];
        	var parent_p = [];
            $.map(this._data.core.selected, $.proxy(function(i) { 
            	obj.push(i); 
            	if(this.get_node(i).parent != "#"){
	            	if($.inArray(this.get_node(i).parent, this._data.core.selected) < 0){
	            		if($.inArray(this.get_node(i).parent, obj) < 0){
	            			obj.push(this.get_node(i).parent);
	            			parent.push(this.get_node(i).parent);
		            		obj_note.push(this.get_node(this.get_node(i).parent))
	            		}
	            	}  
            	}
            	obj_note.push( this.get_node(i) ) 
            },this)); 
            
            $.map(parent, $.proxy(function(i) { 
            	if(this.get_node(i).parent != "#"){
	            	if($.inArray(this.get_node(i).parent, obj) < 0){
	            		if($.inArray(this.get_node(i).parent, obj) < 0){
	            			obj.push(this.get_node(i).parent);
	            			parent_p.push(this.get_node(i).parent);
		            		obj_note.push(this.get_node(this.get_node(i).parent))
	            		}
	            	}  
            	}
            },this)); 
            $.map(parent_p, $.proxy(function(i) { 
            	if(this.get_node(i).parent != "#"){
	            	if($.inArray(this.get_node(i).parent, obj) < 0){
	            		if($.inArray(this.get_node(i).parent, obj) < 0){
	            			obj.push(this.get_node(i).parent);
