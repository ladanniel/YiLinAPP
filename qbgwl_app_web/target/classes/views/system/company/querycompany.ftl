        ...
        <div class="modal-dialog" style="width: 85%;">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title">[${company.name!}]---商户信息</h1>
										                                    ...
										                                    <div class="panel-body">
										                                    	<div>
										                                    		 <div >
											                                         	...
											                                         	<img id="idcard_persoin_img_view" src="${WEB_PATH}<#if idcard.idcard_persoin_img?? && autinfo.idcard.idcard_persoin_img != "">/resources/img/img_no.jpg<#else>${idcard.idcard_persoin_img}</#if>" style="width: 100%;border: 1px solid #e5e6e7;">
											                                         	</a>
											                                         </div>
												                                </div>
										                                    </div>
