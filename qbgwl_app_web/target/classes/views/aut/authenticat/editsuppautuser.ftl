...
<head>
    ...
    <title>用户信息认证</title>
    <meta name="keywords" content="易林物流平台-用户信息认证">
    <meta name="description" content="易林物流平台-用户信息认证">
...
<body class="gray-bg">
                    ...
                    <div class="ibox-title"> 
	                    ...
	                    <div class="ibox-content">
                         <div id="rootwizard" class="tabbable tabs-left">
							...
							<#if account.authentication?string == "supplement">
							  	<#if role.is_aut == true>
							  		<#if role.idcard == true && account.aut_supplement_type?index_of("idcard")!=-1>
									<li><a href="#tab2" data-toggle="tab" id="idcard_info">身份证认证</a></li>
									</#if>
									<#if role.driving_license == true && account.aut_supplement_type?index_of("driving")!=-1>
    ...
    <script>
		...
		function saveUserAutInfo(){
			...
			userAutInfo.type = "supplementedit";
