                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab-1" style="border: none;">
						                    		...
						                    		<div class="form-group">
						                                ...
						                                <div class="col-sm-8">
						                                     <button class="btn btn-primary" type="button"  onclick="sendCode(this,'${USER.phone}')">获取短信验证码</button>
						                                </div>
						                            </div>
						                            </form>
                                            </div>
                                            <div class="tab-pane" id="tab-2" style="border: none;">
						                    		...
						                    		<div class="form-group">
						                                <label class="col-sm-3 control-label"></label>
						                                <div class="col-sm-8">
						                                     <button class="btn btn-primary" type="button"  onclick="sendCode(this,$('#phone').val())">获取短信验证码</button>
						                                </div>
						                            </div>
						                            <div class="form-group">
						                                <label class="col-sm-3 control-label"><span style="color: red;">*&nbsp;&nbsp;</span>验证码：</label>
...
function sendCode(obj,phone) {
    ...
    $.ajax({
		  type: 'POST',
		  url: '${WEB_PATH}/account/register/sendCode.do',  
		  data: {"phone":phone},
		  dataType: "json",
