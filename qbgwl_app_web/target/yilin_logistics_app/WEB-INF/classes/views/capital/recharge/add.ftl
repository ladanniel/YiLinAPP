							...
							<@tradeSequence recharge = "1">
			                        ...
			                        <div id="newCard" hidden="true">
							          ...
							          <div class="form-group">
			                                ...
			                                <div class="col-sm-8">
			                                   <input id="mobile" name="mobile" type="number" class="form-control" minlength="11" required="" aria-required="true" disabled>
			                                </div>
			                           </div>
			                           <div class="form-group">
			                                <label class="col-sm-3 control-label"><span style="color: red;">*&nbsp;&nbsp;</span>手机验证码：</label>
			                                <div class="col-sm-4">
			                                    <input id="code" name="code"  type="number"  maxlength="6"  class="form-control" disabled>
			                                </div>
			                                <div class="col-sm-1">
