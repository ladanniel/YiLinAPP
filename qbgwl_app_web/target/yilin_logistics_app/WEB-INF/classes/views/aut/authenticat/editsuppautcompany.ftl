...
<body class="gray-bg">
                    ...
                    <div class="ibox-title"> 
	                    ...
	                    <div class="ibox-content">
                         <div id="rootwizard" class="tabbable tabs-left">
							...
							<#if company.audit?string == "supplement">
							  	<#if companyType.is_aut == true>
							  		<#if companyType.idcard == true && company.aut_supplement_type?index_of("idcard")!=-1>
									<li><a href="#tab2" data-toggle="tab" id="idcard_info">身份证认证</a></li>
									</#if>
									<#if companyType.driving_license == true && company.aut_supplement_type?index_of("driving")!=-1>
									<li><a href="#tab3" data-toggle="tab" id="driving_license_info">驾驶证认证</a></li>
									</#if>
									<#if companyType.business_license == true && company.aut_supplement_type?index_of("business")!=-1>
					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="idcard_persoin_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div>
							                                    		 <div >
								                                         	<img id="idcard_persoin_img_view" src="${WEB_PATH}<#if idcard.idcard_persoin_img??>/resources/img/shenfenzhengsc.jpg<#else>${idcard.idcard_persoin_img}</#if>" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
    ...
    <script>
		...
		function saveCompanyAutInfo(){
			...
			companyAutInfo.type = "supplementedit";
