        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title"><span style="color: red;">${positiomsParameter.positions_name}</span>--考勤参数设置</h1>
                    ...
                    <div class="modal-body"> 
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="id"name="positionsId"  type="hidden"   class="form-control"  value="${positiomsParameter.positions_id}">
                                    <input id="name"name="positionsName"  type="text"  readonly="readonly" class="form-control"  value="${positiomsParameter.positions_name}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><span style="color: red;">需打考勤天数：</span></label>
                                <div class="col-sm-8">
                                    <input name="xkaoqin" type="number" class="form-control" value="${positiomsParameter.xkaoqin}" required="" aria-required="true" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><span style="color: red;">未打考勤天数：</span></label>
                                <div class="col-sm-8">
                                     <input name="wkaoqin" type="number" class="form-control" value="${positiomsParameter.wkaoqin}" required="" aria-required="true"  >
                                </div>
                            </div> 
                            <div class="form-group">
                                <div style="color: red;">注：如 规定项目经理每月需打考勤22天 ，每月累计未打考勤7天，系统会发送提醒信息到“筑慧通”手机APP上</div>
                            </div> 
                    </div>
        ...
        $('#saveBut').click(function(){
			 ...
			 submitHandler: function(form) 
			   {  
			      ...
			      $.ajax({
					  type: 'POST',
					  url: '${WEB_PATH }/system/positions/updateParameter.do',  
