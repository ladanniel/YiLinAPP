            ...
            <div class="ibox-content">
            	<div class="row">
            		<form class="form-horizontal m-t" id="form" method="post"> 
	            		...
	            		<div class="form-group">
							   <label class="control-label col-md-1 col-md-offset-4"><font color="red">*</font>支付密码</label>
							   <div class="col-md-2">
							           <input type="password" maxlength="6" id="payPassword" name="payPassword" class="form-control" required="" aria-required="true"/>
							   </div>
						</div>
						<div class="form-group">
							   <label class="control-label col-md-1 col-md-offset-4"><font color="red">*</font>重复支付密码</label>
							   <div class="col-md-2">
