			                    ...
			                    <div class="ibox-content">
			                    	<form id="form-transfer" class="wizard-big">
			                                <div class="row" style="margin-top:30px;">
						                                ...
						                                <div class="col-sm-8">
						                                	<select class="form-control" name="source" id="source" style="width:260px">
																...
																<#assign arr = vo.sourceAccount?split("-")>
																	...
																	<#else>
																		<option value="${vo.sourceAccount +"-"+vo.sourcType}"><#if arr[0] == "易林帐户">可用余额:¥${capitalAccount.avaiable?string(',###.00')}<#else>${arr[0] + arr[1]?substring(0,2) +"******" + arr[1]?substring(arr[1]?length - 3,arr[1]?length)}</#if></option>
																	</#if>
																</#list>
																</@tradeSequence>
														    </select>
						                            ...
						                            <div class="form-group row">
						                                <label class="col-sm-4 control-label form-control-static" style="text-align: right;"><span style="color: red;">*&nbsp;&nbsp;</span>选择类型：</label>
						                                <div class="col-sm-8">
