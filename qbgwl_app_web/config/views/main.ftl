    ...
    <div class="wrapper wrapper-content">
        <div class="row">
            <div class="col-sm-6"　id="div2">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <a class="label label-info pull-right">商户信息</a>
                        <h5>商户信息认证完整度</h5>
                    </div>
                    <div class="ibox-content" >
                      	<div style="width:350px; margin: auto auto 0 auto; text-align: center;">
                        	<div id="company_info" style="width: 350px;height: 270px;"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6" id="div3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <a class="label label-info pull-right">个人信息</a>
                        <h5>个人信息认证完整度</h5>
                    </div>
                    <div class="ibox-content" >
                    	<div style="width:350px;margin: auto auto 0 auto; text-align: center;">
                        	<div id="user_info"  style="width: 350px;height: 270px;"></div>
                        </div>
                    </div>
                </div>
            </div>
