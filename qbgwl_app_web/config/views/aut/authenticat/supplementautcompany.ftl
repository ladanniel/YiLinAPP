...
<body class="gray-bg">
                         ...
                         <div id="rootwizard" class="tabbable tabs-left">
							<ul class="nav nav-tabs" id="myTab"> 
							  	<#if companyType.is_aut == true>
							  		<#if companyType.idcard == true && !company.idcard_id??>
									<li><a href="#tab2" data-toggle="tab" id="idcard_info" aria-expanded="true">身份证认证${company.idcard_id}</a></li>
									</#if>
									<#if companyType.driving_license == true && !company.driving_license_id??>
									<li><a href="#tab3" data-toggle="tab" id="driving_license_info">驾驶证认证${company.driving_license_id}</a></li>
									</#if>
									<#if companyType.business_license == true && !company.business_license_id??>
									<li><a href="#tab4" data-toggle="tab" id="business_license_info">营业执照认证${company.business_license_id}</a></li> 
									</#if>
								</#if>
							</ul>
							<div class="tab-content">
							    ...
							    <#if companyType.driving_license == true && !company.driving_license??>
    ...
    <script>
		...
		function saveCompanyAutInfo(){
			...
			companyAutInfo.type = "supplement";
