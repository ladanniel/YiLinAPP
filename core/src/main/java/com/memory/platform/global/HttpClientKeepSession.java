...
public class HttpClientKeepSession {
	...
	public String getResult(String url, String encode) {
		String ret = "";
		try {
	...
	public String postResult(String url, String parms, String encode) {
		String ret = "";
		try {

			CloseableHttpResponse response = post(url, parms);
			HttpEntity entity = response.getEntity();
			ret = EntityUtils.toString(entity, encode);
		} catch (ClientProtocolException e) {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		...
		// HttpClientKeepSession.post("http://localhost:8080/BCP/j_spring_security_check",
		// "j_username=13301330133&j_password=330133");
		//
