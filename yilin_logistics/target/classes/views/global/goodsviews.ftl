<div style="" class="goods ui-sortable"> 
    <div class="row">
    	...
    	<div class="col-sm-4">
    		<p>审核人：<#if goods.auditPerson??><font color="red">无</font><#else>${goods.auditPerson}</#if></p>
    	</div>
    	<div class="col-sm-4">
    		<p>审核时间：<#if goods.auditTime??><font color="red">无</font><#else>${goods.auditTime?string("yyyy-MM-dd HH:mm:ss")}</#if></p>
    	</div>
    	<div class="col-sm-4">
    		<p>装货车辆：<#if goods.stockTypeNames??><font color="red">无</font><#else>${goods.stockTypeNames}</#if></p>
    	</div>
    	<div class="col-sm-4">
    		<p>审核描述：<#if goods.auditCause??><font color="red">无</font><#else>${goods.auditCause}</#if></p>
    	</div>
    	<div class="col-sm-4">
    		<p>备注信息：<#if goods.remark??><font color="red">无</font><#else>${goods.remark}</#if></p>
    	</div>
	</div>
</div>
    ...
    <div class="col-sm-12">
    	<table class="table table-bordered">
           ...
           <tbody>
               <#list list as vo>
                   <tr>
	                    <td><#if vo.goodsType??><font color="red">无</font><#else>${vo.goodsType}</#if></td>
	                    <td><#if vo.goodsName??><font color="red">无</font><#else>${vo.goodsName}</#if></td>
	                    <td><#if vo.weight??><font color="red">无</font><#else>${vo.weight}</#if></td>
	                    <td><#if vo.surplusWeight??><font color="red">无</font><#else><font color="red">${vo.surplusWeight}</font></#if></td>
	                    <td><#if vo.length??><font color="red">无</font><#else>${vo.length}</#if></td>
	                    <td><#if vo.height??><font color="red">无</font><#else>${vo.height}</#if></td>
	                    <td><#if vo.diameter??><font color="red">无</font><#else>${vo.diameter}</#if></td>
	                    <td><#if vo.wingWidth??><font color="red">无</font><#else>${vo.wingWidth}</#if></td>
	              </tr>
               </#list>
           </tbody>                     	
        </table>
