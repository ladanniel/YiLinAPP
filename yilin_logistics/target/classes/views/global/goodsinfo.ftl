           ...
           <tbody>
               <#list list as vo>
                   <tr>
	                    ...
	                    <td><#if vo.goodsTypeName??><font color="red">无</font><#else>${vo.goodsTypeName}</#if></td>
	                    ...
	                    <td><#if vo.length?? || vo.length==0>无<#else><font color="red">${vo.length}</font></#if></td>
	                    <td><#if vo.heigh?? || vo.heigh==0>无<#else><font color="red">${vo.height}</font></#if></td>
	                    <td><#if vo.diameter?? || vo.diameter==0>无</font><#else><font color="red">${vo.diameter}</font></#if></td>
	                    <td><#if vo.wingWidth??  || vo.wingWidth==0>无<#else><font color="red">${vo.wingWidth}</font></#if></td>
	              </tr>
               </#list>                    
           </tbody>                     	
        </table>
