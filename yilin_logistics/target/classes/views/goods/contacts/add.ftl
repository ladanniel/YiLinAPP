        ...
        <div class="modal-dialog" style="width:60%">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title" style="text-align: center;">添加联系人</h1>
                    <form class="form-horizontal m-t" id="addInfo">
                    <div class="modal-body"> 
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><span style="color: red;">*&nbsp;&nbsp;</span>姓名：</label>
                                <div class="col-sm-8">
                                    <input id="name" name="name"  type="text"  class="form-control"  required="" aria-required="true" maxlenth="16">
                                </div>
                            </div> 
                            <div class="form-group">
                            	<label class="col-sm-3 control-label"><span style="color: red;">*&nbsp;&nbsp;</span>地区：</label>
                                <div class="col-sm-8">
                                    <input id="areaFullName" name="areaFullName"  required="" aria-required="true" class="form-control" readonly type="text" value="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                   <input id="address" name="address"  type="text" required="" aria-required="true" class="form-control" maxlegth="255">
                                </div>
                            </div> 
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><span style="color: red;">*&nbsp;&nbsp;</span>电话：</label>
                                <div class="col-sm-8">
                                    <input id="mobile" name="mobile"  type="text"  class="form-control"  required="" aria-required="true" maxlenth="16">
                                </div>
                            </div>
                            <div class="form-group">
                            	<label class="col-sm-3 control-label">email：</label>
                                <div class="col-sm-8">
                                    <input id="email" name="email"  type="text"  class="form-control" maxlenth="32">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="contactsType" id="contactsType">
                                    	<option value="consignee" selected = "selected">收货人</option>
                                    	<option value="consignor" selected = "selected">发货人</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            	<label class="col-sm-3 control-label">联系人位置：</label>
								 <div class="col-sm-8">
								 	...
								 	<input id="point" name="point" hidden="true"/>
...
<script src="${WEB_PATH}/resources/js/city-picker.js"></script>
 ...
 $(function(){  
 		$('#areaFullName').citypicker({areaId:'areaId'}); 
        ...
        $('#saveBut').click(function(){
        	if($("#addInfo").valid()){ 
			      ...
			      $.ajax({
					  type: 'POST',
					  url: '${WEB_PATH }/goods/contacts/add.do',  
