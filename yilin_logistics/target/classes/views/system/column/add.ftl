                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body"> 
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="text"name="s_table_name" minlength="2" type="text"  class="form-control"  required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><span style="color: red;">*&nbsp;&nbsp;</span>表中文名：</label>
                                <div class="col-sm-8">
                                    <input id="text"name="s_table_comment" minlength="2" type="text"  class="form-control"  required="" aria-required="true">
                                </div>
                            </div>
                    </div>
        ...
        $('#saveBut').click(function(){
			 ...
			 submitHandler: function(form) 
			   {  
			      ...
			      $.ajax({
					  type: 'POST',
					  url: '${WEB_PATH }/system/column/add.do',  
