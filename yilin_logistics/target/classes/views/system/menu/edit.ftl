        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <form class="form-horizontal m-t" id="editMenuInfo" style="max-height:450px;overflow-y: auto;">
                    ...
                    <div class="modal-body"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="iconcls" name="iconcls" minlength="2" type="text"  class="form-control" value="${menu.iconcls}"  >
                                </div>
                            </div>
                            <div class="form-group">
