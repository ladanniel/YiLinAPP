            	...
            	<div class="col-sm-3">
	            	<div class="ibox">
	                    <div class="ibox-title" style="background:rgba(113, 140, 22, 0.46)">
	                    	<a href="javascript:void(0)" onclick="delCard('${vo.bankCard}')"><span class="label pull-right">x</span></a>
	                    	<#if vo.hasDefault == 1>
	                    ...
	                    <div class="ibox-content"></br>
	                       <h4>${(vo.bankCard?substring(0,4))!}************${(vo.bankCard?substring(vo.bankCard?length-4,vo.bankCard?length))!}(<#if vo.bankType == "debitCard">储蓄卡</#if><#if vo.bankType == "creditCard">信用卡</#if>)</h4>
	                       </br>
	                    </div>
	                </div>
	            </div>
