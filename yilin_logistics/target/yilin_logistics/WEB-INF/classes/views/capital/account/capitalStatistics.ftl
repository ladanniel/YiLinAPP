            ...
            <div class="col-sm-3">
                <div class="widget style1 lazur-bg">
                    <div class="row">
                        ...
                        <#if type="system">
                        	<span>平台总资金</span>
                        	<span><#if null == capital.totalCapital.total || "" == capital.totalCapital.total>0<#else>${capital.totalCapital.total}</#if>元</span>
                        <#else>
                        	<span>总资金</span>
                        	<span><#if null == capital.totalCapital.total || "" == capital.totalCapital.total>0<#else>${capital.totalCapital.total}</#if>元</span>
                        </#if>
            ...
            <div class="col-sm-3">
                <div class="widget style1 navy-bg">
                    <div class="row">
                        ...
                        <div class="col-xs-8 text-right">
                        	<span>总充值</span>
	                        <span><#if null == capital.totalCapital.totalrecharge || "" == capital.totalCapital.totalrecharge>0<#else>${capital.totalCapital.totalrecharge}</#if>元</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="widget style1 red-bg">
                    <div class="row">
                        ...
                        <div class="col-xs-8 text-right">
                        	<span>总提现</span>
	                        <span><#if null == capital.totalCapital.totalcash>0<#else>${capital.totalCapital.totalcash}</#if>元</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="widget style1 yellow-bg">
                    <div class="row">
                        ...
                        <div class="col-xs-8 text-right">
                            <span>总转账</span>
	                        <span><#if null == capital.totalTransfer.money || "" == capital.totalTransfer.money>0<#else>${capital.totalTransfer.money}</#if>元</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="widget style1 red-bg">
                    <div class="row vertical-align">
                        ...
                        <div class="col-xs-9 text-right">
                            <span>提现待处理</span>
	                        <span><#if null == capital.cashWaitProcess.total || "" == capital.cashWaitProcess.total>0<#else>${capital.cashWaitProcess.total}</#if>笔</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="widget style1 navy-bg" style="background-color: #f8ac59;">
                    <div class="row vertical-align">
                        ...
                        <div class="col-xs-9 text-right">
                        	<span>提现成功</span>
	                        <span><#if null == capital.cashSuccess.total || "" == capital.cashSuccess.total>0<#else>${capital.cashSuccess.total}</#if>笔</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="widget style1 navy-bg" style="background-color: #676a6c;">
                    <div class="row vertical-align">
                        ...
                        <div class="col-xs-9 text-right">
                        	<span>提现失败</span>
	                        <span><#if null == capital.cashFail.total || "" == capital.cashFail.total>0<#else>${capital.cashFail.total}</#if>笔</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="widget style1 lazur-bg" style="background-color: #00bb9c;">
                    <div class="row vertical-align">
                        ...
                        <div class="col-xs-9 text-right">
                        	<span>本月充值</span>
	                        <span><#if "" == capital.monthRecharge.total || null == capital.monthRecharge.total>0<#else>${capital.monthRecharge.total}</#if>笔</span>
	                        <span><#if "" == capital.monthRecharge.money || null == capital.monthRecharge.money>0<#else>${capital.monthRecharge.money}</#if>元</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="widget style1 lazur-bg" style="background-color: #1a7bb9;">
                    <div class="row vertical-align">
                        ...
                        <div class="col-xs-9 text-right">
                            <span>本月提现</span>
	                        <span><#if "" == capital.monthCash.total || null == capital.monthCash.total>0<#else>${capital.monthCash.total}</#if>笔</span>
	                       	<span><#if "" == capital.monthCash.money || null == capital.monthCash.money>0<#else>${capital.monthCash.money}</#if>元</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="widget style1 red-bg">
                    <div class="row vertical-align">
                        ...
                        <div class="col-xs-9 text-right">
                            <span>本月转账</span>
	                       	<span><#if "" == capital.monthTransfer.total || null == capital.monthTransfer.total>0<#else>${capital.monthTransfer.total}</#if>笔</span>
	                        <span><#if "" == capital.monthTransfer.money || null == capital.monthTransfer.money>0<#else>${capital.monthTransfer.money}</#if>元</span>
                        </div>
                    </div>
                </div>
            </div>
