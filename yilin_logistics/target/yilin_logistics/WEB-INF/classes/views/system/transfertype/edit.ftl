                                ...
                                <div class="col-sm-6">
                                    <input id="name" name="name" minlength="2" type="text"  class="form-control"  required="" value="${transferType.name}" aria-required="true" maxlenth="16">
		                                ...
		                                <div class="form-group">
		                                    ...
		                                    <input type="text" name="companyType.id" value="${transferType.companyType.id}" hidden="true"/>
		                                    <div class="col-sm-6">
		                                    	 <p class="form-control-static">${transferType.companyType.name}</p>
		                                    </div>
		                                </div> 
                    </div>
        	 ...
        	 $("#editInfo").validate({
        	 	rules: {
		        	name: {
		                ...
		                remote:{
		                	  type:"POST",
		                      url:"${WEB_PATH }/system/transfertype/checkName.do?oldName=${transferType.name}&transferTypeId=${transferType.companyType.id}",
		                }
		            }
		        },
		        messages: {
