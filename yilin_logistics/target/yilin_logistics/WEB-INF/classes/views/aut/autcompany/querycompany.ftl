        ...
        <div class="modal-dialog" style="width: 85%;">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title">[${company.name!}]---商户信息aaaasss/h1>
							  	...
							  	<div class="col-sm-12">
							        <div class="tabs-container">
							            <ul class="nav nav-tabs">
							            	<li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true">商户信息1111</a> </li>
								                                	...
								                                	<div class="form-group">
									                                    <div class="panel panel-primary" id="idcard_front_img_view_panel">
										                                    ...
										                                    <div class="panel-body">
										                                    	<div >
										                                    		 <div >
										                                    		 	<a class="fancybox" href="${businessLicense.company_img!}" title="营业执照照片">
											                                         	<img id="idcard_front_img_view" src="${businessLicense.company_img!}" style="width: 100%;border: 1px solid #e5e6e7;">
											                                         	</a>
											                                         </div>
												                                </div>
										                                    </div>
