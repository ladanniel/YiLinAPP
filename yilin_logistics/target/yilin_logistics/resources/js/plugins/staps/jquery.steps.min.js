...
function(a, b) {
    ...
    function u(a, b, c, d) {
        if ((0 > d || d >= c.stepCount) && R(Y), !(b.forceMoveForward && d < c.currentIndex)) {
            ...
            return a.triggerHandler("stepChanging", [c.currentIndex, d]) ? (c.currentIndex = d, O(a, b, c), E(a, b, c, e), D(a, b, c), A(a, b, c), P(a, b, c, d, e,
            function() {
    ...
    function E(b, c, d, e) {
        ...
        g = a('<div class="current-info audible">' + c.labels.current + " </div>"),
    ...
    function P(b, c, d, e, f, g) {
        ...
        case ab.slide:
            ...
            function() {
                ...
                c = n(b);
                c.transitionElement && (c.transitionElement[o](j,
                function() {
                    a(this)._showAria()
    ...
    cb = a.fn.steps.defaults = {
        ...
        loadingTemplate: '<div class="spinner"></div> #text#',
        autoFocus: !1,
        enableAllSteps: !1,
