            ...
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <div class="modal-body"> 
                            ...
                            <div class="form-group" >
                                <label class="col-sm-3 control-label" style="text-align: right;">转账用户账号：</label>
                                <div class="col-sm-8">${vo.toAccount.account}</p></div>
                            </div>
                            <div class="form-group" >
                                <label class="col-sm-3 control-label" style="text-align: right;">转账用户手机：</label>
                                <div class="col-sm-8">${vo.toAccount.phone}</p></div>
                            </div>
                            <div class="form-group" >
                                <label class="col-sm-3 control-label" style="text-align: right;">转账用户姓名：</label>
						    ...
						    <div class="form-group">
						         ...
						         <div class="col-sm-8">${vo.money}元</p></div>
						    </div>
						    <div class="form-group">
