                                ...
                                <table id="exampleTableEvents" data-height="520" data-mobile-responsive="true" >
                                    <thead>
                                        <tr>
								            ...
								            <th data-field="account.account">充值用户账号</th>
								            <th data-field="account.phone">充值用户手机</th>
								            <th data-field="account.name">充值用户姓名</th>
    ...
    <script >
    	...
    	$(function(){ 
	    	$("#exampleTableEvents").bootstrapTable({
	            url: "${WEB_PATH }/capital/rechargerecord/getOsPage.do",
	            method: 'get',
	            search:true,
	            pagination:true,
	            pageNumber:1,  
        ...
        $("#export-but").click(function(){
        	...
        	location.href = "${WEB_PATH }/capital/rechargerecord/export.do?start="+start+"&end="+end+"&search="+search+"&status="+status;
        });
