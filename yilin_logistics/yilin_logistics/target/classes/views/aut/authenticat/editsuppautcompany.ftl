					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="idcard_persoin_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div>
							                                    		 <div >
								                                         	<img id="idcard_persoin_img_view" src="<#if idcard.idcard_persoin_img??>${WEB_PATH}/resources/img/shenfenzhengsc.jpg<#else>${idcard.idcard_persoin_img}</#if>" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
