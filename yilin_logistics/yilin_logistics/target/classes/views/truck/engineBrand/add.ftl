        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title">新增发动机品牌</h1>
                    ...
                    <div class="modal-body"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="name" name="first_letter" minlength="1" type="text"  class="form-control"  required="" aria-required="true">
                                </div>
                            </div> 
                    </div>
        ...
        $('#saveBut').click(function(){
			 ...
			 submitHandler: function(form) 
			   {  
			      ...
			      $.ajax({
					  type: 'POST',
					  url: '${WEB_PATH }/truck/engineBrand/save.do',  
