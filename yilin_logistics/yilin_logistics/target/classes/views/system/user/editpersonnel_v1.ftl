                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="account"name="account" maxlength="12" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" type="text" value="${user.account}" class="form-control" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
 		...
 		var e = "<i class='fa fa-times-circle'></i> ";
        	 $("#editUserInfo").validate({
		        ...
		        messages: {
		            account: {
		                required: e + "请输入用户名。",
		                rangelength: e + "用户名由数字英文字母下划线组成并且长度为6到12位字符组成。",
		                remote: e + "用户名重复。"
		            },
		            name: {
		            	required: e + "请输入姓名。",
