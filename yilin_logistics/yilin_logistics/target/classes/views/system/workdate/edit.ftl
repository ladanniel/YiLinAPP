        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title">修改上下班信息</h1>
                    <form class="form-horizontal m-t" id="editWorkDateInfo">
                    <div class="modal-body"> 
                            <div class="form-group">
                            	<input type="hidden" class="form-control"  name="id" value="${workdate.id}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group work_date" data-autoclose="true">
			                            ...
			                            <input type="text" class="form-control" name="go_to_work_date"  value="${workdate.go_to_work_date}" required="" aria-required="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group work_date"  data-autoclose="true">
			                            <input type="text" class="form-control"  name="go_off_work_date" value="${workdate.go_off_work_date}" required="" aria-required="true">
			                            <span class="input-group-addon">
			                                    <span class="fa fa-clock-o"></span>
			                            </span>
			                        </div>
 ...
 $(function(){   
     ...
     //添加角色信息#commentForm
        $('#saveBut').click(function(){
        	 $("#editWorkDateInfo").validate({     
			 submitHandler: function(form) 
			   {  
			   	  $('#saveBut').attr("disabled",true);    
			      $.ajax({
					  type: 'POST',
					  url: '${WEB_PATH}/system/positions/updateWorkDate.do',  
					  data: $('#editWorkDateInfo').serialize(),
					  dataType: "json",
