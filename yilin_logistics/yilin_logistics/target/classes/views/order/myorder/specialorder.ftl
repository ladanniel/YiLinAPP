...
<body class="gray-bg">
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=1AC8RPrl58FNLoYjoEhOiwv8SsgToWRm"></script>
       <script src="http://www.ylwuliu.cn:80/yilin_logistics/resources/js/plugins/fancybox/jquery.fancybox.js"></script>
			 	...
			 	$(".fancybox").fancybox({openEffect:"none",closeEffect:"none"}); 
			 	 ...
			 	 $("#log_info_form").validate(validate_a_submit);
			 	  ...
			 	  $("#saveBtn").on('click',function(){
			 	    ...
			 	    var processingType = $('input:radio[name=processingType]:checked').val();
