        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title">修改货物类型</h1>
                    ...
                    <div class="modal-body"> 
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="name" name="name" minlength="2" type="text" value="${vo.name}"  class="form-control"  required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">备注：</label>
                                <div class="col-sm-8">
                                	<input type="text" name="descs" class="form-control"  value="${vo.descs}"   >
                                </div>
                            </div>
                    </div>
        ...
        $('#saveBut').click(function(){
			 ...
			 submitHandler: function(form) 
			   {  
			      ...
			      $.ajax({
					  type: 'POST',
					  url: '${WEB_PATH }/goods/goodstype/edit.do',  
