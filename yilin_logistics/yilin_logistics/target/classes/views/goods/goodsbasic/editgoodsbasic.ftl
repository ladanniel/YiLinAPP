...
<body class="gray-bg">
        ...
        <div class="row">
        	<div class="modal-footer" style="z-index:99995;text-align: center;">
	        	...
	        	<form id="goodsbasic_detail_info_form">
	        		<input id="id" name="id" type="hidden" value="${goodsBasic.id}">
	        		<input id="deliveryNo" name="deliveryNo" type="hidden" value="${goodsBasic.deliveryNo}">
		            <div class="col-sm-6" style="padding-right: 0px;">
		            	<div class="zero-clipboard">
		            	    <div class="btn-clipboard">
		                       	<button type="button" class="btn btn-primary btn-xs" id="delivery_btn" data-parameter = "consignor"><i class="fa fa-table"></i>&nbsp;发货人选择</button>
		                    </div> 
						</div>
		            		 ...
		            		 <div class="row"> 
		                        <div class="col-sm-6">
		                            <div class="form-group">
		                                ...
		                                <input id="deliveryAreaName" name="deliveryAreaName" class="form-control" readonly type="text" value="${goodsBasic.deliveryAreaName}">
										<input id="deliveryAreaId" name="deliveryAreaId" type="hidden" value="${goodsBasic.deliveryAreaId}">
		                            </div>
		                        </div> 
		                        <div class="col-sm-6">
		                            <div class="form-group">
		                                <label><span style="color: red;">*&nbsp;&nbsp;</span>出发地址：</label>
		                                <input id="deliveryAddress" name="deliveryAddress" type="text" style="width:92%;" class="form-control" placeholder="请输入出发地址" value="${goodsBasic.deliveryAddress}">
		                                ...
		                                <input id="deliveryCoordinate" name="deliveryCoordinate" type="hidden" value="${goodsBasic.deliveryCoordinate}">
		                            </div>
		                        </div> 
		                    </div>
		                     <div class="row">
		                        <div class="col-sm-4">
		                            <div class="form-group">
		                                ...
		                                <input id="deliveryName" name="deliveryName" type="text" class="form-control" placeholder="请输入发货人姓名" value="${goodsBasic.deliveryName}">
		                            </div> 
		                        </div>
		                        <div class="col-sm-4"> 
		                            <div class="form-group">
		                                <label><span style="color: red;">*&nbsp;&nbsp;</span>发货人联系电话：</label>
		                                <input id="deliveryMobile" name="deliveryMobile" type="text" class="form-control" placeholder="请输入发货人联系电话" value="${goodsBasic.deliveryMobile}">
		                            </div>
		                        </div>
		                        <div class="col-sm-4"> 
		                            <div class="form-group">
		                                <label>发货人邮箱：</label>
		                                <input id="deliveryEmail" name="deliveryEmail" type="text" class="form-control" placeholder="请输入发货人邮箱" value="${goodsBasic.deliveryEmail}">
		                            </div>
		                        </div>
		                    </div>
		                </div>
		            		 ...
		            		 <div class="row"> 
		                        <div class="col-sm-6">
		                            <div class="form-group">
		                                ...
		                                <input id="consigneeAreaName" name="consigneeAreaName" class="form-control" readonly type="text" value="${goodsBasic.consigneeAreaName}">
										<input id="consigneeAreaId" name="consigneeAreaId" type="hidden" value="${goodsBasic.consigneeAreaId}">
		                            </div>
		                        </div> 
		                        <div class="col-sm-6">
		                            <div class="form-group">
		                                <label><span style="color: red;">*&nbsp;&nbsp;</span>收货地址：</label>
		                                <input id="consigneeAddress" name="consigneeAddress" type="text" style="width:92%;" class="form-control" placeholder="请输入收货地址" value="${goodsBasic.consigneeAddress}">
		                                ...
		                                <input id="consigneeCoordinate" name="consigneeCoordinate" type="hidden" value="${goodsBasic.consigneeCoordinate}">
		                            </div>
		                        </div> 
		                    </div>
		                     <div class="row">
		                        <div class="col-sm-4">
		                            <div class="form-group">
		                                ...
		                                <input id="consigneeName" name="consigneeName" type="text" class="form-control" placeholder="请输入收货人姓名" value="${goodsBasic.consigneeName}">
		                            </div> 
		                        </div>
		                        <div class="col-sm-4"> 
		                            <div class="form-group">
		                                <label><span style="color: red;">*&nbsp;&nbsp;</span>收货人联系电话：</label>
		                                <input id="consigneeMobile" name="consigneeMobile" type="text" class="form-control" placeholder="请输入收货人联系电话" value="${goodsBasic.consigneeMobile}">
		                            </div>
		                        </div>
		                        <div class="col-sm-4"> 
		                            <div class="form-group">
		                                <label>收货人邮箱：</label>
		                                <input id="consigneeEmail" name="consigneeEmail" type="text" class="form-control" placeholder="请输入收货人邮箱" value="${goodsBasic.consigneeEmail}">
		                            </div>
		                        </div>
		                    </div>
		                </div>
		            		 ...
		            		 <div class="row">
		                        <div class="col-sm-4">
		                            <div class="form-group">
		                                ...
		                                <select data-placeholder="选择货物类型" id="goodsType_id" name="goodsType.id" class="chosen-select form-control">
		                                	<#list goodsTypeList as goodsType >
		                                		<option value="${goodsType.id}" hassubinfo="true" <#if goodsBasic.goodsType.id == goodsType.id>selected = "selected"</#if>>${goodsType.name}</option>
		                                 	</#list>
		                                </select>
		                            </div> 
		                        </div>
		                        <div class="col-sm-4">
		                            <div class="form-group">
		                                <label><span style="color: red;">*&nbsp;&nbsp;</span>有限时间：</label>
		                                <input id="finiteTimeStr" name="finiteTimeStr" class="form-control" style="width:75%;" readonly type="text"  placeholder="请选择时间"  value="<#if goodsBasic.longTime>长期有效<#else>${goodsBasic.finiteTime}</#if>">
		                                <div style="float: right;margin-top: -25px;">
		                                	<div class="checkbox checkbox-success checkbox-inline" >
					                            <input type="checkbox" id="longTimeCheckbox" name="longTimeCheckbox" value="true" <#if goodsBasic.longTime> checked</#if>>
					                            <label for="longTimeCheckbox">是否长期</label>
					                            <input type="hidden" id="longTime" name = "longTime" value="<#if goodsBasic.longTime>true<#else>false</#if>" >
					                        </div>
		                                </div>
		                            </div>
		                        </div> 
		                       <div class="col-sm-4">
		                            <div class="form-group">
		                                ...
		                                <input id="unitPrice" name="unitPrice" type="text" class="form-control" placeholder="请输入货物单价" value="${goodsBasic.unitPrice}">
		                            </div>
		                        </div> 
		                    </div>
		                    <div class="row">
		                        <div class="col-sm-12">
		                              <div class="form-group">
		                                <label>货物说明：</label>
		                                <input id="remark" name="remark" type="text" class="form-control" placeholder="请输入备注信息" value="${goodsBasic.remark}">
		                            </div>
		                        </div>
		                    </div>
		                </div>
		                         ...
		                         <table id="goodsDetail_grid" >
		                            <thead>
		                                <tr>
								            ...
								            <th data-field="goodsTypeId" data-editable="true"  data-type = "select" data-save = "client"  data-validate = "required" data-source="${WEB_PATH}/global/data/getGoodsTypeById.do?id=${goodsBasic.goodsType.id}"><span style="color: red;">*&nbsp;&nbsp;</span>货物类型</th> 
								            ...
								            <th data-field="length"  data-editable="true" data-type = "text" data-save = "client" data-validate = "number" data-formatter="formatLength">长度/米</th> 
								            <th data-field="height" data-editable="true" data-type = "text" data-save = "client" data-validate = "number" data-formatter="formatHeight">高度/米</th> 
								            <th data-field="diameter" data-editable="true" data-type = "text" data-save = "client" data-validate = "number" data-formatter="formatDiameter">直径/cm</th>
									        <th data-field="wingWidth" data-editable="true" data-type = "text" data-save = "client" data-validate = "number" data-formatter="formatWingWidth">翼宽</th>
		                                </tr>
		                            </thead>
		                        </table>
	                        </div>
	...
	<script >
    	...
    	$(function(){
	        ...
	        $("#deliveryAddress").blur(function(){
				...
				if(deliveryAreaName == "" || deliveryAddress == "" ){
					...
					if( deliveryAreaAddress != deliveryAreaName+""+deliveryAddress){
			...
			$("#consigneeAddress").blur(function(){
				...
				if(consigneeAreaName == "" || consigneeAddress == "" ){
					...
					if( consigneeAreaAddress != consigneeAreaName+""+consigneeAddress){
			...
			mapDrivingRoute("${goodsBasic.deliveryCoordinate}","${goodsBasic.consigneeCoordinate}");
        }); 
        jQuery(function($) {
        ...
        $("#add_goodsdetail").click(function(){
       		goodsTypes_id = $("#goodsType_id").val();
        	var options = $("#goodsDetail_grid").bootstrapTable('getOptions');
        	if(options.columns[0][1].editable && options.columns[0][1].type == "select" && options.columns[0][1].field == "goodsTypeId" ){
        		options.columns[0][1].source = "${WEB_PATH}/global/data/getGoodsTypeById.do?id="+goodsTypes_id
        	}
        	$("#goodsDetail_grid").bootstrapTable('refreshOptions', options );
		...
		function saveGoodsBasicDetail(status){
			 ...
			 $.yilinAjax({
		   	  	type:'POST',
		   	  	loadmsg:'努力提交中......',
		   	  	url:'${WEB_PATH }/goods/goodsbasic/editSubGoodsBasicDetail.do',
		   	  	data:goodsBasic,
		   	  	btn:null,
        		errorcallback:null,
		...
		function formatDiameter(val){
			return val == 0 ? "" : val; 
		}
		function formatWingWidth(val){
			return val == 0 ? "" : val; 
		}
