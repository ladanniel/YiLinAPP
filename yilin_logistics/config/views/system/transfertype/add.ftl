        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title">新增转账类型</h1>
                    <form class="form-horizontal m-t" id="addInfo">
                    <div class="modal-body"> 
                            <div class="form-group">
                                <label class="col-sm-5 control-label"><span style="color: red;">*&nbsp;&nbsp;</span>类型名称：</label>
                                <div class="col-sm-6">
                                    <input id="name" name="name" minlength="2" type="text"  class="form-control"  required="" aria-required="true" maxlenth="16">
                                </div>
                            </div> 
                            <div class="form-group">
		                                    <label class="col-sm-5 control-label">商户类型：</label>
		                                    <div class="col-sm-6">
		                                    <select data-placeholder="选择商户类型" id="companyType" name="companyType.id" class="chosen-select form-control" >
        	 ...
        	 $("#addInfo").validate({
        	 	rules: {
		        	name: {
		                ...
		                remote:{
		                	  type:"POST",
		                      url:"${WEB_PATH }/system/transfertype/checkName.do?transferTypeId="+$("#companyType option:selected").val(),
		                }
		            }
		        },
		        messages: {
			 	...
			 	submitHandler: function(form){  
			      ...
			      $.ajax({
					  type: 'POST',
					  url: '${WEB_PATH }/system/transfertype/save.do',  
