...
<body>
				...
				<div class="col-sm-8" style="margin-left:10%;margin-right:10%;">
					<form class="form-horizontal m-t" id="addUserInfo">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="account"name="account" maxlength="16" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" type="text" required="" class="form-control"  aria-required="true">
                                </div>
                            </div>
                           <!-- <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="password" id="password" name="password" class="form-control" maxlenth="16" required="" aria-required="true" >
                                </div>
                            </div> -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                   <input id="phone" name="phone" type="text" class="form-control" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="11" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
			                                <label class="col-sm-3 control-label"><span style="color: red;">*&nbsp;&nbsp;</span>手机验证码：</label>
			                                <div class="col-sm-4">
			                                    <input id="code" name="code"  type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"  maxlength="6"  class="form-control" >
			                                </div>
			                                <div class="col-sm-1">
 ...
 $.validator.setDefaults({
 		...
 		$("#addUserInfo").validate({
		        ...
		        messages: {
		            ...
		            phone: {
		                required: e + "请输入手机号。",
		                remote: e + "手机号已被注册过。",
		                rangelength:e + "请输入正确的手机号。",
		                isMobile:e+"请输入正确的手机号。"
		            }
		        }
		   });
	...
	$("#send").on('click',function(){
	    ...
	    $.ajax({
			  type: 'POST',
			  url: webPath+'/system/user/addSendCode.do',  
			  data: {"phone":phone},
			  dataType: "json",
