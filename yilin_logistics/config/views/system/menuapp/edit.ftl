	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-8">
	                                 <select class="form-control" name="appType">
										 <option value="MoneyManager" <#if menuApp.appType == 'MoneyManager'>selected = "selected"</#if>>资金管理</option>
					                     <option value="SupplyManager" <#if menuApp.appType == 'SupplyManager'>selected = "selected"</#if>>货源管理</option> 
	                                 </select> 
	                                </div> 
	                            </div>
	                            <div class="form-group">
