        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title">新增银行信息</h1>
                    ...
                    <div class="modal-body"> 
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="cnName" name="cnName" maxlength="36" type="text"  class="form-control"  required="" aria-required="true">
                                </div>
                            </div> 
                            <div class="form-group">
                                <label class="col-sm-5 control-label"><span style="color: red;">*&nbsp;&nbsp;</span>银行英文缩写：</label>
                                <div class="col-sm-6">
                                    <input id="shortName" name="shortName" maxlength="8" type="text"  class="form-control"  required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <a href="javascript:void(0)" class="file" id="company_img_view_btn"  >
    																					...
    																					<input type="file" id="bank_logo_image" datatype="BANK"  name="file" onchange="javascript:setImagePreview1(this);">
    																					<input type="hidden" id="bank_logo"  name="image" >
																					</a>
                                </div>
                            </div>
                            <div class="form-group">
       ...
       var e = "<i class='fa fa-times-circle'></i> ";
        	 $("#addBankInfo").validate({
        	 	rules: {
		        	cnName: {
		                ...
		                remote:{
		                	  type:"POST",
		                      url:"${WEB_PATH }/system/bank/checkCnName.do?oldName=",
		                }
		            },
		            shortName: {
		                required: !0,
		                remote:{
		                	  type:"POST",
		                      url:"${WEB_PATH }/system/bank/checkShortName.do?oldName=",
		                }
		            }
		        },
		        messages: {
		...
		$("#saveBut").click(function(){
			...
			if(validImage() && $("#addBankInfo").valid()){
			   	  ...
			   	  $.ajax({
					  type: 'POST',
					  url: '${WEB_PATH }/system/bank/add.do',  
