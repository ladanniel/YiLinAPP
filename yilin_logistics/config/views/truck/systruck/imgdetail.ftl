        ...
        <div class="modal-dialog" style="width: 85%;height:30px">
            <div id="rootwizard" class="modal-content animated bounceInRight">
                <div class="modal-header" style="text-align: center;">
                    ...
                    <h5 class="modal-title" style="text-align: center;">${truckImg.truck.track_no}</h5>
                    <span class="label label-danger">车辆图片信息,可在下面表单修改图片</span>
                    <div  class="modal-body" style="max-height:450px;overflow-y: auto;"> 
                         <div  class="tabbable tabs-left">
							<ul class="nav nav-tabs" id="myTab">
							       <input id="truckid" name="truck.id" type="hidden"  class="form-control" value="${truckImg.truck.id}" >
					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="track_ahead_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div >
							                                    		 <div >
							                                    		 <#if truckImg.track_ahead_img != null>
								                                         	<img id="track_ahead_img_view" src="${truckImg.track_ahead_img}" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
							                                    		 <#if truckImg.track_ahead_img == null>
								                                         	<img id="track_ahead_img_view" src="${WEB_PATH}/resources/img/img_no.jpg" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
												                                	<a href="javascript:void(0)" class="file" id="idcard_front_img_view_btn" >
    																					...
    																					<input type="hidden" id="track_ahead_img" name = "track_ahead_img" value="${truckImg.track_ahead_img}">
																					</a>
																				</div>
												                            </div>
								                                         </div>
					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="track_left_front_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div>
								                                         <div >
								                                         <#if truckImg.track_left_front_img!=null>
								                                         	<img id="track_left_front_img_view" src="${truckImg.track_left_front_img}" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>
								                                         <#if truckImg.track_left_front_img==null>
								                                         	<img id="track_left_front_img_view" src="${WEB_PATH}/resources/img/img_no.jpg" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
												                                	<a href="javascript:void(0)" class="file" id="idcard_back_img_view_btn"  >
    																					...
    																					<input type="hidden" id="track_left_front_img"  name="track_left_front_img" value="${truckImg.track_left_front_img}">
																					</a>
																				</div>
												                            </div>
								                                         </div>
					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="track_right_front_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div>
							                                    		 <div >
							                                    		 <#if truckImg.track_right_front_img!=null>
								                                         	<img id="track_right_front_img_view" src="${truckImg.track_right_front_img}" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
							                                    		 <#if truckImg.track_right_front_img==null>
								                                         	<img id="track_right_front_img_view" src="${WEB_PATH}/resources/img/img_no.jpg" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
												                                	<a href="javascript:void(0)" class="file" id="idcard_persoin_img_view_btn"  >
    																					...
    																					<input type="hidden" id="track_right_front_img"  name="track_right_front_img" value="${truckImg.track_right_front_img}">
																					</a>
																				</div>
												                            </div>
								                                         </div>
					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="track_abehind_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div >
							                                    		 <div >
							                                    		 <#if truckImg.track_abehind_img!=null>
								                                         	<img id="track_abehind_img_view" src="${truckImg.track_abehind_img}" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
							                                    		 <#if truckImg.track_abehind_img==null>
								                                         	<img id="track_abehind_img_view" src="${WEB_PATH}/resources/img/img_no.jpg" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
												                                	<a href="javascript:void(0)" class="file" id="idcard_front_img_view_btn" >
    																					...
    																					<input type="hidden" id="track_abehind_img" name = "track_abehind_img" value="${truckImg.track_abehind_img}">
																					</a>
																				</div>
												                            </div>
								                                         </div>
					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="track_behind_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div>
							                                    		 <div >
							                                    		 <#if truckImg.track_behind_img!=null>
								                                         	<img id="track_behind_img_view" src="${truckImg.track_behind_img}" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
							                                    		 <#if truckImg.track_behind_img==null>
								                                         	<img id="track_behind_img_view" src="${WEB_PATH}/resources/img/img_no.jpg" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
												                                	<a href="javascript:void(0)" class="file" id="idcard_persoin_img_view_btn"  >
    																					...
    																					<input type="hidden" id="track_behind_img"  name="track_behind_img" value="${truckImg.track_behind_img}">
																					</a>
																				</div>
												                            </div>
								                                         </div>
					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="track_side_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div>
							                                    		 <div >
							                                    		 <#if truckImg.track_side_img!=null>
								                                         	<img id="track_side_img_view" src="${truckImg.track_side_img}" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
							                                    		 <#if truckImg.track_side_img==null>
								                                         	<img id="track_side_img_view" src="${WEB_PATH}/resources/img/img_no.jpg" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
												                                	<a href="javascript:void(0)" class="file" id="idcard_persoin_img_view_btn"  >
    																					...
    																					<input type="hidden" id="track_side_img"  name="track_side_img" value="${truckImg.track_side_img}">
																					</a>
																				</div>
												                            </div>
								                                         </div>
					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="track_console_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div>
							                                    		 <div >
						                                    		 <#if truckImg.track_console_img!=null>
								                                         	<img id="track_console_img_view" src="${truckImg.track_console_img}" style="width: 100%;border: 1px solid #e5e6e7;">
								                                      </#if>
						                                    		 <#if truckImg.track_console_img==null>
								                                         	<img id="track_console_img_view" src="${WEB_PATH}/resources/img/img_no.jpg" style="width: 100%;border: 1px solid #e5e6e7;">
								                                      </#if>
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
												                                	<a href="javascript:void(0)" class="file" id="idcard_persoin_img_view_btn"  >
    																					...
    																					<input type="hidden" id="track_console_img"  name="track_console_img" value="${truckImg.track_console_img}">
																					</a>
																				</div>
												                            </div>
								                                         </div>
					                                	...
					                                	<div class="form-group">
						                                    <div class="panel panel-primary" id="track_dashboard_img_view_panel">
							                                    ...
							                                    <div class="panel-body">
							                                    	<div>
							                                    		 <div >
							                                    		 <#if truckImg.track_dashboard_img!=null>
								                                         	<img id="track_dashboard_img_view" src="${truckImg.track_dashboard_img}" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
							                                    		 <#if truckImg.track_dashboard_img==null>
								                                         	<img id="track_dashboard_img_view" src="${WEB_PATH}/resources/img/img_no.jpg" style="width: 100%;border: 1px solid #e5e6e7;">
								                                         </#if>	
								                                         	<div class="form-group" style="width:100%;padding-top: 5px;">
												                                <div>
												                                	<a href="javascript:void(0)" class="file" id="idcard_persoin_img_view_btn"  >
    																					...
    																					<input type="hidden" id="track_dashboard_img"  name="track_dashboard_img" value="${truckImg.track_dashboard_img}">
																					</a>
																				</div>
												                            </div>
								                                         </div>
                    ...
                    <ul class="pager wizard" style="text-align: right;padding-right: 20px;">
						<li class="previous"><button class="btn btn-primary " type="button"><i class="fa fa-arrow-circle-left"></i>&nbsp;&nbsp;<span class="bold">上一步</span></button></li>
					  	...
					  	<li class="finish"><button class="btn btn-primary btn-danger" id="savecompanyaut" type="button"><i class="fa fa-check"></i>&nbsp;<span class="bold">确认修改</span></button></li>
					</ul>
                </div>
            </div>
        </div> 
...
function saveCompanyAutInfo(){
	...
	$.yilinAjax({
   	  	type:'POST',
   	  	url:'${WEB_PATH }/truck/truckimg/update.do',
   	  	//data:null,
