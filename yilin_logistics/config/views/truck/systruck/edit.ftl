                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body" style="max-height:450px;overflow-y: auto;"> 
                        <form class="m-t" id="editTruckInfo">
                        	...
                        	<input name="yy_vehicel_id" type="hidden"  class="form-control" value="${truck.yy_vehicel_id}" >
                        	<input name="yy_vehicel_key" type="hidden"  class="form-control" value="${truck.yy_vehicel_key}" >
	                        ...
	                        <div style="" class="company ui-sortable">
		                        ...
		                        <div class="row">
		                            ...
		                            <div class="col-sm-4">
		                                <div class="form-group">
		                                    <label>SIM卡号：</label>
		                                    <input name="sim_card_id" id="sim_card_id" type="text" value="${truck.sim_card_id}" class="form-control" placeholder="请输SIM卡Id号">
		                                </div>
		                            </div>
		                            <div class="col-sm-4">
		                                <div class="form-group">
		                                    <label>GPS设备号：</label>
		                                    <input name="gps_device_id" id="gps_device_id" value="${truck.gps_device_id}" type="text" class="form-control" placeholder="请输入GPS设备号">
		                                </div>
		                            </div> 	                                          
		                        </div>
		                    </div>
