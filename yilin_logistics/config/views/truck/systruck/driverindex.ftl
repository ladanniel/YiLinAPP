	        ...
	        <div class="col-sm-12" style=" padding-bottom: 10px;">
            	<div style="" class="goodsbasic ui-sortable" >
                    <div class="row">
				    	...
				    	<div class="col-sm-8">
				    		<p>备注信息：<#if goods.remark??><font color="red">无</font><#else>${goodsBasic.remark}</#if></p>
				    	</div>
					</div>
				</div> 
			 </div> 
	        ...
	        <div class="col-sm-12" style=" padding-bottom: 10px;">
            	<div style="" class="consignor ui-sortable" >
                    <div class="row">
				    	...
				    	<div class="col-sm-4">
				    		<p>发货人email：<#if goodsBasic.deliveryEmail??><font color="red">无</font><#else>${goodsBasic.deliveryEmail}</#if></p>
				    	</div>
					 </div>
					 ...
					 <div class="row">
				    	...
				    	<div class="col-sm-4">
				    		<p>收货人email：<#if goodsBasic.consigneeEmail??><font color="red">无</font><#else>${goodsBasic.consigneeEmail}</#if></p>
				    	</div>
					</div> 
				</div> 
			 </div> 
