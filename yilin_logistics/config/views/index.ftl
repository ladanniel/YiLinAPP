        ...
        <@import.leftMenuImportHtml/>  
         ...
         <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" id="main_title" data-id="${WEB_PATH }/system/admin/main.do"></a>
                    </div>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="yiling_iframe" id="yiling_iframe" width="100%" height="100%" src="${WEB_PATH }/system/admin/main.do" frameborder="0" data-id="${WEB_PATH }/system/admin/main.do" seamless></iframe>
            </div>
            <div class="footer">
