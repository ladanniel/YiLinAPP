...
<body class="gray-bg">
			                        ...
			                        <div class="row">
			                         ...
			                         <div class="row">
			                            ...
			                            <div class="col-sm-4">
			                               <div class="input-group">
			                                <label>发货商户：</label>
					                        <input type="text" class="form-control" id="robbedCompany" name="robbedCompany">
					                        <div class="input-group-btn">
					                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
					                                <span class="caret"></span>
					                            </button>
    ...
    <script >
		...
		function subTableFormatter_1(index, row, $detail){
			  ...
			  info.load("${WEB_PATH }/order/orderlog/view/statusinfo.do?robConfirmId="+row.robConfirmId);
		}
