...
// 控制JAXB 绑定类中属性和字段的排序
@XmlType(propOrder = { "return_code", "return_msg", "appid", "mch_id", "device_info", "nonce_str", "sign",
		"result_code", "err_code", "err_code_des", "openid", "is_subscribe", "trade_type", "bank_type", "total_fee",
		"fee_type", "cash_fee", "cash_fee_type", "coupon_fee", "coupon_count", "transaction_id", "out_trade_no",
		"attach", "time_end", })

@Entity
@Table(name = "wei_xin_pay_call_back")
public class WeiXinPayCallBack extends BaseEntity implements Serializable {
	...
	public String toSignStr() {
		...
		BeanKVO.enumProperty(this, new EnumPropertyCallBack() {
			...
			public boolean callback(String propertyName, Object value) {
				if (propertyName.equals("class") || propertyName.equals("toSignStr") || propertyName.equals("sign")
						|| propertyName.equals("coupon_count") || propertyName.equals("return_msg")
						|| propertyName.equals("id") || propertyName.equals("create_time")
						|| propertyName.equals("update_time") || propertyName.equals("add_user_id")
						|| propertyName.equals("update_user_id") || propertyName.equals("coupon_fee")) {
					return true;
				}
				if (value != null) {
