package com.memory.platform.interceptor.views;
...
public class SpringMvcViewResolver {
	private static Log logger = LogFactory.getLog(SpringMvcViewResolver.class);
